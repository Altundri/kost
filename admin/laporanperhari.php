...
include "koneksi.php";
 if (isset($_POST['cari'])){
  ...
  $sql= mysqli_query($con, "SELECT DISTINCT *  FROM pelanggan INNER JOIN transaksi ON pelanggan.id_pelanggan = transaksi.id_pelanggan INNER JOIN konfirmasi ON transaksi.id_transaksi = konfirmasi.id_transaksi WHERE konfirmasi.status='Y' && transaksi.tgl_masuk = '$hari_ini' ");
  }else{
...
<br>
<a href="admin.php?module=cetakperhari&hari_ini=<?php echo $_POST['hari_ini'];?>"class="btn btn-success"><i class="fa-solid fa-print"></i> CETAK</a>
</br>